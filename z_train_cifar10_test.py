...
# tf.app.flags.DEFINE_integer('batch_size', 256, None)
tf.app.flags.DEFINE_boolean('bool_eval', False, None)
tf.app.flags.DEFINE_boolean('demo', True, None)
...
def main():
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        images_train, of_stack_batch, labels_train, rootb, nameb, indxb, flags = z_input.get_2stream_input(FLAGS,
                                                                                                         of_stack_num=5)
        ...
        learning_rate = tf.train.exponential_decay(0.001, global_step, decay_step, 0.1)
